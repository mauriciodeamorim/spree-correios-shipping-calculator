...
describe "Sedex10Calculator", "When there is no weight" do

  before(:each) do
    @calculator = Sedex10Calculator.new
...
describe "Sedex10Calculator", "When there is weight" do
  ...
  it "should send default parameters" do
    parameters = {
      :nCdEmpresa => '',
      :sDsSenha => '',
      :nCdServico => '40215', # Código do Sedex10
      :nCdFormato => 0.to_s,
...
describe "Sedex10Calculator", "WebService Error" do
